...
<Info>
If you're upgrading from v4.x, see the [upgrade guide](/migration/upgrade-to-v5) for detailed migration instructions.
</Info>
...
<Tip>
This example uses client credentials authentication. For interactive user authentication, see the [authentication documentation](/core-concepts/authentication).
</Tip>
